      ...
      <div className="row cart">
        <div className="col-lg-7">
          <div className="cart-image">
            <img
              src="https://cdn.shopify.com/s/files/1/0684/2619/products/Mens-Enofe-African-Print-Blazer-Green-Adinkra2_700x.jpg?v=1664244886"
              alt="placeholder"
              className="img-fluid"
            />
          </div>
        ...
        <div className="col-lg-5 cart-text ">
          <div>
            ...
            <h3>Styles:</h3>
            <ul>
              <li>This style is best in wedding.</li>
            </ul>
          </div>
