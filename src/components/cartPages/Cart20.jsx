      ...
      <div className="row cart">
        <div className="col-lg-7">
          <div className="cart-image">
            <img
              src="https://cdn.shopify.com/s/files/1/0684/2619/products/Ise-Men_s-Reversible-Bomber-Jacket-Navy-Gold-Paisley2_1000x1400.jpg?v=1602170947"
              alt="placeholder"
              className="img-fluid"
            />
          </div>
        ...
        <div className="col-lg-5 cart-text ">
          <div>
            <h1>Igitenge Jacket</h1>

            <p className="cart-price">
              <strong>Price: </strong> 240$
            </p>
            <h3>Description:</h3>
            <ul>
              <li>100% Denim</li>
