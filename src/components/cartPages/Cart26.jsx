      ...
      <div className="row cart">
        <div className="col-lg-7">
          <div className="cart-image">
            <img
              src="https://cdn.shopify.com/s/files/1/0684/2619/products/dresses-ronke-african-print-halter-maxi-dress-black-brown-geometric-1-Copy_1000x1400.jpg?v=1657136864"
              alt="placeholder"
              className="img-fluid"
            />
          </div>
